...
resolveMagnetLink = function(hashIndex)
{
	...
	// Quick dirty edit. Nothing to see here.
	var pointer = infohs;
	
	infohs = eth.storageAt(dbADDR,infohs).bin();
	...
	document.getElementById('infohashInputField').value = infohs;
...
updateDocument = function()
{
	...
	var infohash = (document.getElementById("infohashInputField").value).unbin().pad(0,32);
