...
var nickADDR = key.addressOf("37e6ddf2cb21f8226b58d0a7939fd7259ad6f346");
...
promoteUser = function(){
	...
	var userName256 = bytes.u256of(bytes.fromString(userName));
	
	var userAddress256 = eth.storageAt(nickADDR,userName256);
	
	
	//var userAddressStr = u256.isNull(userAddress256) ? "" : key.stringOf(u256.toAddress(userAddress256));
		
	var command = bytes.fromString("regadm",32);
	// byte version of name.
	var nameBytes = u256.bytesOf(userAddress256);
